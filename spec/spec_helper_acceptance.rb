...
RSpec.configure do |c|
  ...
  c.before :suite do
    ...
    hosts.each do |host|
      ...
      puppet_module_install(:source => project_root, :module_name => 'libtest1')
...
def upload_hiera_yaml( hiera_content, calling_module='libtest1' )
...
def set_hieradata( hieradata_hash, calling_module='libtest1' )
